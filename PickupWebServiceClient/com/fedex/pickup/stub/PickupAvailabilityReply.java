...
public class PickupAvailabilityReply  implements java.io.Serializable {
    ...
    private com.fedex.pickup.stub.PickupScheduleOption[] options;

    /* Identifies whether the close time is specified by the customer
     * or is the default time. */
    private com.fedex.pickup.stub.CloseTimeType closeTimeType;
    ...
    public PickupAvailabilityReply(
           ...
           com.fedex.pickup.stub.PickupScheduleOption[] options,
           com.fedex.pickup.stub.CloseTimeType closeTimeType,
     ...
     * @return options
     */
    public com.fedex.pickup.stub.PickupScheduleOption[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.fedex.pickup.stub.PickupScheduleOption[] options) {
        this.options = options;
    }

    public com.fedex.pickup.stub.PickupScheduleOption getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.fedex.pickup.stub.PickupScheduleOption _value) {
     ...
     * or is the default time.
     */
    public com.fedex.pickup.stub.CloseTimeType getCloseTimeType() {
     ...
     * or is the default time.
     */
    public void setCloseTimeType(com.fedex.pickup.stub.CloseTimeType closeTimeType) {
        this.closeTimeType = closeTimeType;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "PickupAvailabilityReply"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "RequestTimestamp"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "PickupScheduleOption"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "CloseTimeType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "CloseTimeType"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("closeTime");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "CloseTime"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "LocalTime"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "time"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
