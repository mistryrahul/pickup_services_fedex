...
public class EMailLabelDetail  implements java.io.Serializable {
    ...
    private com.fedex.pickup.stub.EMailRecipient[] recipients;
    ...
    public EMailLabelDetail(
           ...
           com.fedex.pickup.stub.EMailRecipient[] recipients) {
     ...
     * @return recipients
     */
    public com.fedex.pickup.stub.EMailRecipient[] getRecipients() {
        return recipients;
    }
     ...
     * @param recipients
     */
    public void setRecipients(com.fedex.pickup.stub.EMailRecipient[] recipients) {
        this.recipients = recipients;
    }

    public com.fedex.pickup.stub.EMailRecipient getRecipients(int i) {
        return this.recipients[i];
    }

    public void setRecipients(int i, com.fedex.pickup.stub.EMailRecipient _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "EMailLabelDetail"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "Recipients"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "EMailRecipient"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
