...
public class RecommendedDocumentSpecification  implements java.io.Serializable {
    private com.fedex.pickup.stub.RecommendedDocumentType[] types;

    public RecommendedDocumentSpecification() {
    }

    public RecommendedDocumentSpecification(
           com.fedex.pickup.stub.RecommendedDocumentType[] types) {
           this.types = types;
    }
     ...
     * @return types
     */
    public com.fedex.pickup.stub.RecommendedDocumentType[] getTypes() {
        return types;
    }
     ...
     * @param types
     */
    public void setTypes(com.fedex.pickup.stub.RecommendedDocumentType[] types) {
        this.types = types;
    }

    public com.fedex.pickup.stub.RecommendedDocumentType getTypes(int i) {
        return this.types[i];
    }

    public void setTypes(int i, com.fedex.pickup.stub.RecommendedDocumentType _value) {
        this.types[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "RecommendedDocumentSpecification"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("types");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "Types"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "RecommendedDocumentType"));
