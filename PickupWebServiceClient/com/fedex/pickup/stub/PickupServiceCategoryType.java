...
public class PickupServiceCategoryType implements java.io.Serializable {
    ...
    // Constructor
    protected PickupServiceCategoryType(java.lang.String value) {
        _value_ = value;
    ...
    public static PickupServiceCategoryType fromValue(java.lang.String value)
    ...
    public static PickupServiceCategoryType fromString(java.lang.String value)
          throws java.lang.IllegalArgumentException {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "PickupServiceCategoryType"));
    }
    /**
