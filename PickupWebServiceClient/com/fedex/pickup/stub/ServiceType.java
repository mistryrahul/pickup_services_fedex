...
public class ServiceType implements java.io.Serializable {
    ...
    public static final java.lang.String _FEDEX_INTERNATIONAL_PRIORITY_PLUS = "FEDEX_INTERNATIONAL_PRIORITY_PLUS";
    ...
    public static final java.lang.String _SAME_DAY_METRO_AFTERNOON = "SAME_DAY_METRO_AFTERNOON";
    public static final java.lang.String _SAME_DAY_METRO_MORNING = "SAME_DAY_METRO_MORNING";
    public static final java.lang.String _SAME_DAY_METRO_RUSH = "SAME_DAY_METRO_RUSH";
    ...
    public static final ServiceType FEDEX_INTERNATIONAL_PRIORITY_PLUS = new ServiceType(_FEDEX_INTERNATIONAL_PRIORITY_PLUS);
    ...
    public static final ServiceType SAME_DAY_METRO_AFTERNOON = new ServiceType(_SAME_DAY_METRO_AFTERNOON);
    public static final ServiceType SAME_DAY_METRO_MORNING = new ServiceType(_SAME_DAY_METRO_MORNING);
    public static final ServiceType SAME_DAY_METRO_RUSH = new ServiceType(_SAME_DAY_METRO_RUSH);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "ServiceType"));
    }
    /**
