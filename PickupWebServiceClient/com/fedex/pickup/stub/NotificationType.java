...
public class NotificationType implements java.io.Serializable {
    ...
    public static final java.lang.String _SMS_TEXT_MESSAGE = "SMS_TEXT_MESSAGE";
    public static final NotificationType EMAIL = new NotificationType(_EMAIL);
    public static final NotificationType FAX = new NotificationType(_FAX);
    public static final NotificationType SMS_TEXT_MESSAGE = new NotificationType(_SMS_TEXT_MESSAGE);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "NotificationType"));
    }
    /**
