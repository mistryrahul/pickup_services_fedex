...
public class ShipmentDryIceDetail  implements java.io.Serializable {
    ...
    private com.fedex.pickup.stub.ShipmentDryIceProcessingOptionsRequested processingOptions;
    ...
    public ShipmentDryIceDetail(
           ...
           com.fedex.pickup.stub.ShipmentDryIceProcessingOptionsRequested processingOptions) {
     ...
     */
    public com.fedex.pickup.stub.ShipmentDryIceProcessingOptionsRequested getProcessingOptions() {
        return processingOptions;
    }
     ...
     */
    public void setProcessingOptions(com.fedex.pickup.stub.ShipmentDryIceProcessingOptionsRequested processingOptions) {
        this.processingOptions = processingOptions;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "ShipmentDryIceDetail"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "ShipmentDryIceProcessingOptionsRequested"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
