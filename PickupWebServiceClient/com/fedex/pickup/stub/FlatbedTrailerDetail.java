...
public class FlatbedTrailerDetail  implements java.io.Serializable {
    private com.fedex.pickup.stub.FlatbedTrailerOption[] options;

    public FlatbedTrailerDetail() {
    }

    public FlatbedTrailerDetail(
           com.fedex.pickup.stub.FlatbedTrailerOption[] options) {
     ...
     * @return options
     */
    public com.fedex.pickup.stub.FlatbedTrailerOption[] getOptions() {
        return options;
    }
     ...
     * @param options
     */
    public void setOptions(com.fedex.pickup.stub.FlatbedTrailerOption[] options) {
        this.options = options;
    }

    public com.fedex.pickup.stub.FlatbedTrailerOption getOptions(int i) {
        return this.options[i];
    }

    public void setOptions(int i, com.fedex.pickup.stub.FlatbedTrailerOption _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "FlatbedTrailerDetail"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("options");
        elemField.setXmlName(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "Options"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://fedex.com/ws/pickup/v13", "FlatbedTrailerOption"));
